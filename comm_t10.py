...
if checkbox_value2:
    ...
    st.subheader(f'Predictions for the last {day_es} days', divider='green')
...
if checkbox_value4:
    ...
    st.subheader(f'Predictions for the last {day_s} days', divider='green')
...
if checkbox_value5:
    ...
    st.subheader(f'Predictions for the last {day_s1} days', divider='green')
